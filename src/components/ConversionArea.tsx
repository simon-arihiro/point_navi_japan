...
export default function ConversionArea({ service }: Props) {
  ...
  return (
    <div className="bg-gradient-to-br from-red-50 to-orange-50 border border-red-100 rounded-2xl p-6">
      <h2 className="font-bold text-gray-900 text-base mb-4">お得な招待情報</h2>
      ...
      {service.referral_link && (
        <a
          ...
          className="block w-full text-center bg-gray-900 text-white font-bold py-3 rounded-xl hover:bg-gray-800 transition-colors"
        >
          招待リンクから登録する →
        </a>
      )}
