...
const FEEDBACK = `この記事を全体的に見直し、AI生成記事特有の「テンプレ感」を徹底的に排除してください。書き出し・本文・締めのすべてを対象に、不自然な定型表現や当たり障りのない一般論を、りすくんのリアルな体験談風の文章に書き直してください。見出し構成・記事の趣旨・対象サービス・記載されている事実情報は変更しないこと。`;
