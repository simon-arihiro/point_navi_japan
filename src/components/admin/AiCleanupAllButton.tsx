...
const FEEDBACK = `この記事は文章の「文体・言い回し」だけを修正してください。AI生成記事特有の不自然な定型表現（テンプレ的な書き出し・締めの一文、過度に砕けた語尾や（笑）等の記号で親しみを演出する書き方など）を排除し、終始「です・ます調」で統一された、辛口で実利重視の独立系ブロガーらしい自然な文体に書き直してください。
