...
export async function GET(request: NextRequest) {
  ...
  const [ga4Summary, ga4TopPages, ga4Daily, gscSummary, gscTopQueries, gscTopPages] = await Promise.all([
    getGa4Summary(days),
    getGa4TopPages(days),
  ...
  return Response.json({ ga4Summary, ga4TopPages, ga4Daily, gscSummary, gscTopQueries, gscTopPages });
}
